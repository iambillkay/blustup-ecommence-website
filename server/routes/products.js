...
router.post("/admin", requireAuth, adminRequired, upload.array("images", 10), productController.createProduct);
router.patch("/admin/:id", requireAuth, adminRequired, upload.array("images", 10), productController.updateProduct);
...
router.post("/", requireAuth, adminRequired, upload.array("images", 10), productController.createProduct);
router.put("/:id", requireAuth, adminRequired, upload.array("images", 10), productController.updateProduct);
// Some clients might prefer PATCH too.
router.patch("/:id", requireAuth, adminRequired, upload.array("images", 10), productController.updateProduct);
